// APP COCHO CENTRAL V7.1.4 SUPABASE — CONSOLIDAR PROVISÓRIO DUPLICADO
const CACHE_NAME='app-cocho-central-v7-1-4-consolidar-provisorio-duplicado';
const CORE=['./','./index.html?v=7.1.4','./manifest.json?v=7.1.4','./icons/icon-192.png','./icons/icon-512.png'];
