// APP COCHO CENTRAL V7.2 SUPABASE — HIGIENIZAR COCHOS DUPLICADOS
const CACHE_NAME='app-cocho-central-v7-2-higienizar-cochos-duplicados';
const CORE=['./','./index.html?v=7.2','./manifest.json?v=7.2','./icons/icon-192.png','./icons/icon-512.png'];
