// APP COCHO CENTRAL V7.1.7 SUPABASE — SELEÇÃO PERSISTENTE FIX
const CACHE_NAME='app-cocho-central-v7-1-7-selecao-persistente-fix';
const CORE=['./','./index.html?v=7.1.7','./manifest.json?v=7.1.7','./icons/icon-192.png','./icons/icon-512.png'];
