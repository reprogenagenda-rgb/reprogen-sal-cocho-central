...
const CACHE_NAME='app-cocho-central-v6-8-estoque-produto';
const CORE=['./','./index.html?v=6.8','./manifest.json?v=6.8','./icons/icon-192.png','./icons/icon-512.png'];
