// APP COCHO CENTRAL V7.3 SUPABASE — MAPA DE COCHOS
const CACHE_NAME='app-cocho-central-v7-3-mapa-cochos';
const CORE=['./','./index.html?v=7.3','./manifest.json?v=7.3','./icons/icon-192.png','./icons/icon-512.png'];
