// APP COCHO CENTRAL V7.1.2 SUPABASE — LISTAR PROVISÓRIOS CLOUD FIX
const CACHE_NAME='app-cocho-central-v7-1-2-listar-provisorios-cloud-fix';
const CORE=['./','./index.html?v=7.1.2','./manifest.json?v=7.1.2','./icons/icon-192.png','./icons/icon-512.png'];
