...
const CACHE_NAME='app-cocho-central-v6-5-1-consumo-animais-fix';
const CORE=['./','./index.html?v=6.5.1','./manifest.json?v=6.5.1','./icons/icon-192.png','./icons/icon-512.png'];
