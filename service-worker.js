// APP COCHO CENTRAL V7.1.6 SUPABASE — BLOQUEIO OFICIAL DUPLICADO GPS
const CACHE_NAME='app-cocho-central-v7-1-6-bloqueio-oficial-duplicado-gps';
const CORE=['./','./index.html?v=7.1.6','./manifest.json?v=7.1.6','./icons/icon-192.png','./icons/icon-512.png'];
