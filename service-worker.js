// APP COCHO CENTRAL V6.5 SUPABASE — RELATÓRIO DE CONSUMO
const CACHE_NAME='app-cocho-central-v6-5-relatorio-consumo';
const CORE=['./','./index.html?v=6.5','./manifest.json?v=6.5','./icons/icon-192.png','./icons/icon-512.png'];
