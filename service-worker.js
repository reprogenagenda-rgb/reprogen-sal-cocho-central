// APP COCHO CENTRAL V7.2.3 SUPABASE — DIAGNÓSTICO AUTOMÁTICO
const CACHE_NAME='app-cocho-central-v7-2-3-diagnostico-automatico';
const CORE=['./','./index.html?v=7.2.3','./manifest.json?v=7.2.3','./icons/icon-192.png','./icons/icon-512.png'];
