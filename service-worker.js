// APP COCHO CENTRAL V7.2.1 SUPABASE — HIGIENIZAÇÃO AMPLIADA
const CACHE_NAME='app-cocho-central-v7-2-1-higienizacao-ampliada';
const CORE=['./','./index.html?v=7.2.1','./manifest.json?v=7.2.1','./icons/icon-192.png','./icons/icon-512.png'];
