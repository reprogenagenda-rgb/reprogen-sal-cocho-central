// APP COCHO CENTRAL V7.1.3 SUPABASE — CONFIRMAR E TRANSFERIR HISTÓRICO
const CACHE_NAME='app-cocho-central-v7-1-3-confirmar-transferir-historico';
const CORE=['./','./index.html?v=7.1.3','./manifest.json?v=7.1.3','./icons/icon-192.png','./icons/icon-512.png'];
