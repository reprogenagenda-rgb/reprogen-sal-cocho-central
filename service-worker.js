// APP COCHO CENTRAL V7.2.2 SUPABASE — DIAGNÓSTICO COCHOS
const CACHE_NAME='app-cocho-central-v7-2-2-diagnostico-cochos';
const CORE=['./','./index.html?v=7.2.2','./manifest.json?v=7.2.2','./icons/icon-192.png','./icons/icon-512.png'];
