...
const CACHE_NAME='app-cocho-central-v6-8-1-estoque-cloud-fix';
const CORE=['./','./index.html?v=6.8.1','./manifest.json?v=6.8.1','./icons/icon-192.png','./icons/icon-512.png'];
