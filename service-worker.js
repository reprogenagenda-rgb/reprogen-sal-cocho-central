// APP COCHO CENTRAL V7.1 SUPABASE — CONFIRMAR COCHOS PROVISÓRIOS
const CACHE_NAME='app-cocho-central-v7-1-confirmar-cochos-provisorios';
const CORE=['./','./index.html?v=7.1','./manifest.json?v=7.1','./icons/icon-192.png','./icons/icon-512.png'];
