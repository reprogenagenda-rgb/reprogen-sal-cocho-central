// APP COCHO CENTRAL V6.6 SUPABASE — FECHAMENTO DE CONSUMO
const CACHE_NAME='app-cocho-central-v6-6-fechamento-consumo';
const CORE=['./','./index.html?v=6.6','./manifest.json?v=6.6','./icons/icon-192.png','./icons/icon-512.png'];
