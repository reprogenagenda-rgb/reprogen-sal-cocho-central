...
const CACHE_NAME='app-cocho-central-v6-7-custo-produto';
const CORE=['./','./index.html?v=6.7','./manifest.json?v=6.7','./icons/icon-192.png','./icons/icon-512.png'];
